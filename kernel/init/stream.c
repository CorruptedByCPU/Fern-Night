...
void kernel_init_stream() {
	...
	kernel -> stream_base_address = (struct KERNEL_STRUCTURE_STREAM *) kernel_memory_alloc( MACRO_PAGE_ALIGN_UP( KERNEL_STREAM_limit * sizeof( struct KERNEL_TASK_STRUCTURE ) ) >> STATIC_PAGE_SIZE_shift );
